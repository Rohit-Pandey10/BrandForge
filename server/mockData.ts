...
export const PRESET_PITCHES: PresetPitch[] = [
  {
...
export function generateGenericMockQuestion(currentRound: number, pitch: string): QuestionResponse {
...
export function generateGenericMockBrandKit(pitch: string, _history: unknown[] = []): BrandKit {
  const domain = classifyDomain(pitch);
