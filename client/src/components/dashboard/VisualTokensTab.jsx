    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <section className="bg-white rounded-[28px] border border-[#dbd7cd] p-6 sm:p-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-6 pb-4 border-b border-[#dbd7cd]">
          <div>
            <span className="text-[10px] uppercase tracking-widest text-stone-400 font-medium block mb-1">PALETTE SPECIFICATION</span>
            ...
            return (
              ...
              >
                ...
                <div className="p-3 bg-white flex flex-col gap-1 border-t border-[#dbd7cd]/40">
                  ...
                  <span className="text-[10px] uppercase tracking-wider text-stone-400">{color.role}</span>
                  ...
                  {/* WCAG badge */}
                  {contrast && (
                    <span className={`text-[9px] font-mono px-1.5 py-0.5 rounded border mt-1 w-fit ${levelColor}`}>
                      WCAG {level} · {contrast}
                    </span>
                  )}
                </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-[28px] border border-[#dbd7cd] p-6 sm:p-8 flex flex-col justify-between transition-all duration-200 hover:-translate-y-0.5">
          <div>
            <div className="flex items-center justify-between mb-3 pb-3 border-b border-[#dbd7cd]">
              <span className="text-[10px] uppercase tracking-widest text-stone-400 font-medium">DISPLAY TYPOGRAPHY</span>
            ...
            <div className="flex items-center gap-1 mb-4">
              {Object.keys(VIEWPORT_SIZES).map(vp => (
                <button
                  ...
                  className={`text-[10px] px-2 py-0.5 rounded-full border transition-all ${viewport === vp ? 'bg-black text-white border-black' : 'border-[#dbd7cd] text-stone-500 hover:border-black hover:text-black'}`}
                >
                  {vp}
                </button>
              ))}
        ...
        <div className="bg-white rounded-[28px] border border-[#dbd7cd] p-6 sm:p-8 flex flex-col justify-between transition-all duration-200 hover:-translate-y-0.5">
          <div>
            <div className="flex items-center justify-between mb-3 pb-3 border-b border-[#dbd7cd]">
              <span className="text-[10px] uppercase tracking-widest text-stone-400 font-medium">BODY & UI TYPOGRAPHY</span>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-[28px] border border-[#dbd7cd] p-6 sm:p-8 transition-all duration-200 hover:-translate-y-0.5">
          <span className="text-[10px] uppercase tracking-widest text-stone-400 font-medium block mb-2">AESTHETIC FOUNDATION</span>
        ...
        <div className="bg-white rounded-[28px] border border-[#dbd7cd] p-6 sm:p-8 flex flex-col justify-between transition-all duration-200 hover:-translate-y-0.5">
          <div>
            <span className="text-[10px] uppercase tracking-widest text-stone-400 font-medium block mb-2">GEOMETRY RULES</span>
            ...
            <div className="flex items-center gap-4 bg-[#fcfbf9] p-4 rounded-xl border border-[#dbd7cd]">
              <div className={`w-14 h-14 bg-stone-900 border border-stone-800 flex items-center justify-center text-white text-[10px] font-mono ${borderCurvature || 'rounded-xl'}`}>
                Shape
              </div>
              <div>
      ...
      <section className="bg-white rounded-[28px] border border-[#dbd7cd] p-6 sm:p-8">
        <div className="flex items-center justify-between mb-4 pb-3 border-b border-[#dbd7cd]">
          <div>
            <span className="text-[10px] uppercase tracking-widest text-stone-400 font-medium block mb-1">COMPILED CODE SPECIFICATION</span>
